  ...
  <div class="row justify-content-md-center">
    <div class="col-md-6 col-sm-12 grid-margin stretch-card">
      <div class="card">
        ...
        <div class="card-body">
          <h4 class="card-title">Claim Point</h4>
          <form class="forms-sample" method="POST" action="{{url('point_claim/store')}}">
            @csrf
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a href="javascript:void(0)" onclick="hapus('{{url('point_claim/destroy/'.$key->id)}}')" class="btn btn-sm btn-danger">delete</a>
                  </td>
                </tr>
                @endforeach
              </tbody>
